...
export default function TeacherMarks() {
  ...
  return (
    <div className="page">
      ...
      <div className="panel">
        <div className="panelTitle">Upload form</div>
        <form onSubmit={submit} className="form">
          ...
          <div className="panel" style={{ background: "rgba(255,255,255,0.03)" }}>
            <div className="panelTitle">Components</div>
            ...
            <div className="muted" style={{ marginTop: 8 }}>
              Tip: you can upload partially; grade appears only after all 5 components are uploaded.
            </div>
          </div>

          <button className="btn" type="submit" disabled={!semester || !course || !rollNo}>
            Upload marks
          </button>
        </form>
      </div>
